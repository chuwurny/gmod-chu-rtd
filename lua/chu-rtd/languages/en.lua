...
lang:Phrase("effect.taunt-bullets.name", "Taunt bullets")
...
lang:Phrase("effect.explosion.name", "Explode")
lang:Phrase("effect.firework.name", "Firework")
lang:Phrase("effect.dissolve.name", "Dissolve")
lang:Phrase("effect.snail.name", "Snail")
lang:Phrase("effect.freeze.name", "Freeze")
lang:Phrase("effect.timebomb.name", "Time bomb")
lang:Phrase("effect.ignite.name", "Ignition")
...
lang:Phrase("effect.earthquake.name", "Earthquake")
...
lang:Phrase("effect.airstrike.name", "Airstrike")
lang:Phrase("effect.its-raining-nades.name", "It's raining men! Hallelujah!")
lang:Phrase("effect.explosive-bullets.name", "Explosive bullets")
lang:Phrase("effect.fast-hands.name", "Fast hands")
...
lang:Phrase("effect.napalm-timebomb.name", "Napalm time bomb")
...
lang:Phrase("effect.aimbot.name", "Aimbot")
lang:Phrase("effect.strip-weapons.name", "Strip weapons")
lang:Phrase("effect.scary.name", "Scary")
lang:Phrase("effect.car-crash.name", "Car crash")
